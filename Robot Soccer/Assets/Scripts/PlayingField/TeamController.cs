...
public class TeamController : MonoBehaviour {
    ...
    RobotCarController.TEAM team;
    List<GameObject> Defenders;
    List<GameObject> Midfielders;
    List<GameObject> Forward;
    GameObject Goalie;
    ...
    public void Initialize(RobotCarController.TEAM teamColor, int noOfRobots )
    {
        ...
        int m = -1;
        if (team == RobotCarController.TEAM.RED)
        {
            m = 1;
        ...
        switch (noOfRobots)
        {
            case 3:
                ...
                Goalie.GetComponent<RobotCarController>().Initialize(team);
                ...
                rc.GetComponent<RobotCarController>().Initialize(team);
            ...
            case 5:
                ...
                rd.GetComponent<RobotCarController>().Initialize(team);
            ...
            case 11:
                ...
                for (int i = 0; i < League.Large.MidfielderPosition.Length; i++)
                {
                    ...
                    mid.GetComponent<RobotCarController>().Initialize(team);
                ...
                for (int i = 0; i < League.Large.DefenderPosition.Length; i++)
                {
                    ...
                    def.GetComponent<RobotCarController>().Initialize(team);
                ...
                for (int i = 0; i < League.Large.ForwardPosition.Length; i++)
                {
                    ...
                    forw.GetComponent<RobotCarController>().Initialize(team);
