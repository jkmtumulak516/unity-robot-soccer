...
using System.Text;
using UnityEngine;
using static ExperimentAngle;

namespace Assets.Scripts
{
    class RightWheelFLS
    {
        private readonly RelativeAngle angle = new RelativeAngle(1);
        private readonly Distance distance = new Distance(2);
        private readonly Torque torque = new Torque(3);
        ...
        public IList<ParentRule> CreateRules()
        {
            ...
            //Very Left
            listOfRules.Add(builder.Var(angle.VeryRight).And().Var(distance.VeryNear).Build(torque.FastBackward));
            listOfRules.Add(builder.Var(angle.VeryRight).And().Var(distance.Near).Build(torque.Backward));
            listOfRules.Add(builder.Var(angle.VeryRight).And().Var(distance.Medium).Build(torque.SlowBackward));
            listOfRules.Add(builder.Var(angle.VeryRight).And().Var(distance.Far).Build(torque.SlowBackward));
            listOfRules.Add(builder.Var(angle.VeryRight).And().Var(distance.VeryFar).Build(torque.Stop));

            //Left
            listOfRules.Add(builder.Var(angle.Right).And().Var(distance.VeryNear).Build(torque.FastBackward));
            listOfRules.Add(builder.Var(angle.Right).And().Var(distance.Near).Build(torque.Backward));
            listOfRules.Add(builder.Var(angle.Right).And().Var(distance.Medium).Build(torque.SlowBackward));
            listOfRules.Add(builder.Var(angle.Right).And().Var(distance.Far).Build(torque.SlowBackward));
            listOfRules.Add(builder.Var(angle.Right).And().Var(distance.VeryFar).Build(torque.SlowForward));

            //Slightly Left
            listOfRules.Add(builder.Var(angle.SlightlyRight).And().Var(distance.VeryNear).Build(torque.Backward));
            listOfRules.Add(builder.Var(angle.SlightlyRight).And().Var(distance.Near).Build(torque.Stop));
            listOfRules.Add(builder.Var(angle.SlightlyRight).And().Var(distance.Medium).Build(torque.SlowForward));
            ...
            listOfRules.Add(builder.Var(angle.SlightlyLeft).And().Var(distance.Near).Build(torque.Forward));
            listOfRules.Add(builder.Var(angle.SlightlyLeft).And().Var(distance.Medium).Build(torque.Forward));
            ...
            //Right
            listOfRules.Add(builder.Var(angle.Left).And().Var(distance.VeryNear).Build(torque.FastForward));
            listOfRules.Add(builder.Var(angle.Left).And().Var(distance.Near).Build(torque.Forward));
            ...
            //Very Right
            listOfRules.Add(builder.Var(angle.VeryLeft).And().Var(distance.VeryNear).Build(torque.FastForward));
            listOfRules.Add(builder.Var(angle.VeryLeft).And().Var(distance.Near).Build(torque.FastForward));
            listOfRules.Add(builder.Var(angle.VeryLeft).And().Var(distance.Medium).Build(torque.Forward));
            listOfRules.Add(builder.Var(angle.VeryLeft).And().Var(distance.Far).Build(torque.Forward));
            listOfRules.Add(builder.Var(angle.VeryLeft).And().Var(distance.VeryFar).Build(torque.Forward));
