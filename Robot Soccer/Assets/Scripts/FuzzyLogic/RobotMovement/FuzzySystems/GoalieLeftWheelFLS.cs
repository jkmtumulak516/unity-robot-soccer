...
{
    public class GoalieLeftWheelFLS
    {
        ...
        public List<ParentRule> CreateRules()
        {
            ...
            // Mostly Left
            listOfRules.Add(builder.Var(angle.MostlyLeft).And().Var(distance.VeryNear).Build(torque.Stop));
            listOfRules.Add(builder.Var(angle.MostlyLeft).And().Var(distance.Near).Build(torque.SlowBackward));
            listOfRules.Add(builder.Var(angle.MostlyLeft).And().Var(distance.Medium).Build(torque.Backward));
            listOfRules.Add(builder.Var(angle.MostlyLeft).And().Var(distance.Far).Build(torque.Backward));
            listOfRules.Add(builder.Var(angle.MostlyLeft).And().Var(distance.VeryFar).Build(torque.FastBackward));

            //Left
            //listOfRules.Add(builder.Var(angle.Left).And().Var(distance.VeryNear).Build(torque.Stop));
            //listOfRules.Add(builder.Var(angle.Left).And().Var(distance.Near).Build(torque.Stop));
            //listOfRules.Add(builder.Var(angle.Left).And().Var(distance.Medium).Build(torque.Stop));
            //listOfRules.Add(builder.Var(angle.Left).And().Var(distance.Far).Build(torque.Stop));
            //listOfRules.Add(builder.Var(angle.Left).And().Var(distance.VeryFar).Build(torque.Stop));

            //Slightly Left
            listOfRules.Add(builder.Var(angle.SlightlyLeft).And().Var(distance.VeryNear).Build(torque.Stop));
            listOfRules.Add(builder.Var(angle.SlightlyLeft).And().Var(distance.Near).Build(torque.SlowForward));
            ...
            listOfRules.Add(builder.Var(angle.SlightlyRight).And().Var(distance.Near).Build(torque.FastForward));
            listOfRules.Add(builder.Var(angle.SlightlyRight).And().Var(distance.Medium).Build(torque.FastForward));
            ...
            //Right
            //listOfRules.Add(builder.Var(angle.Right).And().Var(distance.VeryNear).Build(torque.Forward));
            //listOfRules.Add(builder.Var(angle.Right).And().Var(distance.Near).Build(torque.FastForward));
            ...
            // Mostly Right
            listOfRules.Add(builder.Var(angle.MostlyRight).And().Var(distance.VeryNear).Build(torque.Backward));
            listOfRules.Add(builder.Var(angle.MostlyRight).And().Var(distance.Near).Build(torque.FastBackward));
            listOfRules.Add(builder.Var(angle.MostlyRight).And().Var(distance.Medium).Build(torque.FastBackward));
            listOfRules.Add(builder.Var(angle.MostlyRight).And().Var(distance.Far).Build(torque.FastBackward));
